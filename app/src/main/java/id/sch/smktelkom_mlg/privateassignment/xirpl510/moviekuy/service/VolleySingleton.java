package id.sch.smktelkom_mlg.privateassignment.xirpl510.moviekuy.service;
...
import id.sch.smktelkom_mlg.privateassignment.xirpl510.moviekuy.fragment.PopularFragment;
import id.sch.smktelkom_mlg.privateassignment.xirpl510.moviekuy.fragment.SoonFragment;
...
public class VolleySingleton {
    ...
    private static SoonFragment mCtx3;
    ...
    private VolleySingleton(SoonFragment context2) {
        if (mInstance != null) {
            throw new RuntimeException(
                    "Use getInstance() method to get the single instance of this class");
        }
    ...
    public static VolleySingleton getInstance(SoonFragment context2) {
        if (mInstance == null) {
            synchronized (VolleySingleton.class) {
