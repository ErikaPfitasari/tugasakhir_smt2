...
public class Soon extends RecyclerView.Adapter<Soon.MyViewHolder> {
    public String url = "https://image.tmdb.org/t/p/w500";
    public String image;
    ArrayList<Results> mlist;
    SoonFragment upcomFragment;
    Context context;
    private int lastposition = -1;

    public Soon(SoonFragment upcomFragment, ArrayList<Results> mlist, Context context) {
        this.mlist = mlist;
    ...
    @Override
    public Soon.MyViewHolder onCreateViewHolder(ViewGroup parent,
                                                    int viewType) {
        // create a new view
    ...
    @Override
    public void onBindViewHolder(Soon.MyViewHolder holder, int position) {
