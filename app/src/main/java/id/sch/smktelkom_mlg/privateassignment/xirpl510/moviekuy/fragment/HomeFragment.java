...
import id.sch.smktelkom_mlg.privateassignment.xirpl510.moviekuy.adapter.Home;
...
public class HomeFragment extends Fragment {
    ...
    private void downloadDataResource() {
        String url = "https://api.themoviedb.org/3/movie/now_playing?api_key=9d4ef824d45886432d634bd6290346f8&language=en-US&page=1";
